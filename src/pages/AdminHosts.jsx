...
import {
  Search, UserCheck, UserX, Building2, Briefcase,
  DollarSign, Star, Settings, Eye, Loader2, MapPin, Users // Added Users
} from 'lucide-react';
...
export default function AdminHosts() {
  ...
  const filteredHosts = hosts
    .filter(host => {
      const matchesSearch = host.full_name?.toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card className={`cursor-pointer transition-all ${filterType === 'all' ? 'ring-2 ring-purple-500' : ''}`} onClick={() => setFilterType('all')}>
          ...
          <Card className={`cursor-pointer transition-all ${filterType === 'agency' ? 'ring-2 ring-indigo-500' : ''}`} onClick={() => setFilterType('agency')}>
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
          ...
          <Card className={`cursor-pointer transition-all ${filterType === 'freelancer' ? 'ring-2 ring-green-500' : ''}`} onClick={() => setFilterType('freelancer')}>
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="flex flex-col lg:flex-row gap-4 justify-between">
                      ...
                      <div className="flex items-start gap-3 mb-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 flex-wrap mb-2">
                            <h3 className="text-lg font-bold text-gray-900">{host.full_name || host.email}</h3>
                            <Badge className={host.host_type === 'agency' ? 'bg-indigo-100 text-indigo-800' : 'bg-green-100 text-green-800'}>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm text-gray-600">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <span>{host.rating?.toFixed(1) || '5.0'} ({host.completed_bookings || 0} bookings)</span>
                            </div>
                          </div>
                    ...
                    <div className="flex flex-col gap-2 lg:w-48">
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() => toggleHostMutation.mutate({
                          hostId: host.id,
