...
import { Heart, Shield, Globe, Users, Award, Sparkles, Target, Eye, CheckCircle, MapPin, Info, Star } from 'lucide-react';
  ...
  const values = [
    {
      ...
      description: "We believe in creating genuine relationships between travelers and local hosts, fostering cultural exchange and mutual respect"
    },
    {
      icon: Shield,
      title: "Trust & Safety",
      description: "Every host is carefully verified and every experience is designed with your safety and comfort in mind"
    },
    {
      icon: Globe,
      title: "Community First",
      description: "We empower local communities by creating sustainable tourism opportunities that benefit everyone"
    },
    {
      icon: Users,
      title: "Personalized Experiences",
      description: "No two journeys are alike. We match you with hosts who understand your interests and travel style"
    }
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
            ...
            <motion.div
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-6">
                We believe the best way to experience a destination is through the eyes of those who call it home. SAWA connects travelers with verified local hosts who share their culture, stories, and insider knowledge.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                Our platform empowers communities while creating meaningful connections between travelers and the places they visit.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-6">
                We envision a future where travel creates lasting bonds between cultures, where every visitor becomes a friend, and where tourism benefits local communities sustainably.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                Through technology and human connection, we're building bridges across the Middle East and beyond.
              </p>
            </motion.div>
          </div>
        </div>
              ...
              {cities.map((city, index) => (
                <motion.div
                  ...
                  <div className="aspect-[4/3] overflow-hidden">
                    <img
                      src={city.cover_image || 'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?w=800'}
                      alt={city.name}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <motion.div
            ...
            <p className="text-lg lg:text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Join thousands of travelers discovering the Middle East through authentic local experiences
            </p>
