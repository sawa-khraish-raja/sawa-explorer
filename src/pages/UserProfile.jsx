...
import { Loader2, Camera, Save, User, Mail, Phone, Globe, MapPin, Calendar, ArrowLeft, Briefcase, Shield, Bell, Lock, Trash2, AlertTriangle } from 'lucide-react';
  ...
  const handleProfileUpdate = async (e) => {
    ...
    try {
      ...
      if (newProfileImageFile) {
        const { file_url } = await base44.integrations.Core.UploadFile({ file: newProfileImageFile });
        photoUrl = file_url;
      }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            <TabsList className="grid w-full grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2 bg-white p-2 rounded-xl shadow-md border border-gray-100">
              <TabsTrigger value="profile" className="flex items-center gap-2 data-[state=active]:bg-[#E6E6FF] data-[state=active]:text-[#330066] rounded-lg">
                <User className="w-4 h-4" />
                Profile
              </TabsTrigger>
              {isHost && (
                <TabsTrigger value="host" className="flex items-center gap-2 data-[state=active]:bg-[#E6E6FF] data-[state=active]:text-[#330066] rounded-lg">
                  <Briefcase className="w-4 h-4" />
                  Host Settings
                </TabsTrigger>
              )}
              <TabsTrigger value="security" className="flex items-center gap-2 data-[state=active]:bg-[#E6E6FF] data-[state=active]:text-[#330066] rounded-lg">
                <Shield className="w-4 h-4" />
                Security
              </TabsTrigger>
              <TabsTrigger value="notifications" className="flex items-center gap-2 data-[state=active]:bg-[#E6E6FF] data-[state=active]:text-[#330066] rounded-lg">
                <Bell className="w-4 h-4" />
                Notifications
              </TabsTrigger>
              <TabsTrigger value="account" className="flex items-center gap-2 data-[state=active]:bg-[#E6E6FF] data-[state=active]:text-[#330066] rounded-lg">
                ...
                <Card className="bg-white shadow-2xl border-2 border-[#CCCCFF]">
                  ...
                  <CardContent className="p-6 lg:p-8">
                    <div className="flex items-center gap-6 mb-8 pb-8 border-b border-gray-100">
                      ...
                      <div>
                        <h3 className="text-xl font-bold text-gray-900 mb-1">{profileData.full_name || 'User'}</h3>
                    ...
                    <form onSubmit={handleProfileUpdate} className="space-y-6">
                      <div className="space-y-2">
                        <Label htmlFor="full_name" className="text-base font-semibold text-gray-700">
                          Full Name
                        </Label>
                        <Input
                          id="full_name"
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="instagram_profile" className="text-base font-semibold text-gray-700">
                          Instagram Profile
                        </Label>
                        <Input
                  ...
                  <CardContent className="p-6 lg:p-8">
                    ...
                    <div className="space-y-4">
                      <div className="space-y-2">
                        ...
                        <Input type="password" id="current-password" placeholder="********" className="h-12 border-2 border-[#CCCCFF] focus:border-[#9933CC] rounded-xl" />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="new-password" className="text-base font-semibold text-gray-700">New Password</Label>
                        <Input type="password" id="new-password" placeholder="********" className="h-12 border-2 border-[#CCCCFF] focus:border-[#9933CC] rounded-xl" />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="confirm-password" className="text-base font-semibold text-gray-700">Confirm New Password</Label>
                        <Input type="password" id="confirm-password" placeholder="********" className="h-12 border-2 border-[#CCCCFF] focus:border-[#9933CC] rounded-xl" />
                      </div>
                  ...
                  <CardContent className="p-6 lg:p-8 space-y-6">
                    <div className="bg-red-50 border-2 border-red-200 rounded-xl p-6">
                      ...
                      <p className="text-sm text-gray-600 italic">
                        Note: Some data may be retained for legal and compliance purposes as outlined in our Privacy Policy.
                      </p>
                    </div>
                    ...
                    <p className="text-center text-sm text-gray-500">
                      Need help instead? <a href={createPageUrl('CustomerSupport')} className="text-purple-600 hover:underline">Contact Support</a>
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
