...
export default function PerformanceReport() {
  ...
  const analysis = {
    ...
    database: {
      score: 75,
      issues: [
        { severity: 'medium', text: 'بعض الـ Queries بدون staleTime - راح تتكرر كتير' },
        { severity: 'high', text: 'في queries بتحمل كل المستخدمين - لازم pagination' },
        { severity: 'low', text: 'في refetch كل 5 ثواني بصفحة Messages - ممكن نزيده' }
      ],
      recommendations: [
    ...
    codeSplitting: {
      score: 85,
      issues: [
        { severity: 'low', text: 'بعض الـ components الكبيرة ممكن تكون lazy' }
      ],
      recommendations: [
    ...
    animations: {
      score: 90,
      issues: [
        { severity: 'low', text: 'بعض الـ animations ممكن تستخدم will-change' }
      ],
      recommendations: [
    ...
    api: {
      score: 75,
      issues: [
        { severity: 'medium', text: 'في parallel requests ممكن تكون sequential' },
    ...
    bundle: {
      score: 70,
      issues: [
        { severity: 'high', text: 'moment.js كبيرة - استخدم date-fns بدلاً منها' },
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3 p-3 bg-red-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-red-700">أكبر مشكلة! استخدم lazy loading و WebP format</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-orange-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-orange-700">استبدل moment.js بـ date-fns (توفير 200KB+)</p>
                </div>
              </div>
