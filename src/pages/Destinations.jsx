...
export default function Destinations() {
  ...
  const { data: cities = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      const allCities = await base44.entities.City.list('name');
      
      const activeCities = allCities.filter(city => 
        city && 
  ...
  const regularCities = cities.filter(city => !city.is_featured);
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-white/95 font-medium drop-shadow-lg max-w-2xl mx-auto">
              Discover authentic experiences in every city, guided by local hosts who know their home best
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {isLoading ? (
            ...
            <div className="text-center py-20">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">No destinations available yet</h3>
      ...
      <section className="section-padding bg-gradient-to-br from-[#330066] via-[#7B2CBF] to-[#9933CC] text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <h2 className="text-3xl lg:text-5xl font-bold mb-6">Can't find what you're looking for?</h2>
...
function CityCard({ city, featured = false, index = 0 }) {
  ...
  const tagline = city.description || cityTaglines[city.name] || 'Discover authentic local experiences';
  ...
  return (
    ...
    >
      <div className="relative aspect-[4/3] overflow-hidden">
        <img
          src={city.card_image || city.cover_image || 'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?w=800'}
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6">
          ...
          {city.country && (
            <p className="text-white/90 text-sm mb-2">{city.country}</p>
          )}
        </div>
      </div>
      ...
      <CardContent className="p-6">
        ...
        <Button 
          className="w-full bg-gradient-to-r from-[#330066] to-[#9933CC] hover:from-[#47008F] hover:to-[#AD5CD6] text-white rounded-xl h-11 font-semibold group-hover:shadow-lg transition-all"
        >
          Explore {city.name}
