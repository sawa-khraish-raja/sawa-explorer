...
export default function CustomerSupport() {
  ...
  const metrics = useMemo(() => {
    ...
    const last24h = users.filter(
      (u) => now - new Date(u.created_date).getTime() <= 24 * 60 * 60 * 1000
    );
    const last7d = users.filter(
      (u) => now - new Date(u.created_date).getTime() <= 7 * 24 * 60 * 60 * 1000
    );
    ...
    return {
      ...
      alerts: {
        ...
        total:
          ...
          unrespondedConvos.length +
          pendingAdventures.length,
      },
      system: {
    ...
    <AdminLayout>
      <div className='space-y-6'>
              ...
              <Card className='border-l-4 border-l-red-500 bg-red-50'>
                <CardContent className='p-4'>
                  <div className='flex items-center justify-between'>
                    <div>
                      ...
                      <p className='text-2xl font-bold text-red-600'>
                        {metrics.alerts.pendingCancellations}
                      </p>
                    </div>
                  ...
                  <Button
                    ...
                    onClick={() => (window.location.href = '/AdminCancellations')}
                  >
                    Review Now
                  </Button>
                </CardContent>
              ...
              <Card className='border-l-4 border-l-blue-500 bg-blue-50'>
                <CardContent className='p-4'>
                  <div className='flex items-center justify-between'>
                    <div>
                      ...
                      <p className='text-2xl font-bold text-blue-600'>
                        {metrics.alerts.unrespondedMessages}
                      </p>
                    </div>
                  ...
                  <Button
                    ...
                    variant='outline'
                    className='w-full mt-3'
                    onClick={() => (window.location.href = '/AdminMessages')}
                  >
                    Check Messages
                  </Button>
                </CardContent>
              ...
              <Card className='border-l-4 border-l-purple-500 bg-purple-50'>
                <CardContent className='p-4'>
                  <div className='flex items-center justify-between'>
                    <div>
                      ...
                      <p className='text-2xl font-bold text-purple-600'>
                        {metrics.alerts.pendingAdventures}
                      </p>
                    </div>
                  ...
                  <Button
                    ...
                    variant='outline'
                    className='w-full mt-3'
                    onClick={() => (window.location.href = '/AdminAdventures')}
                  >
                    Review Adventures
                  </Button>
                </CardContent>
            ...
            <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
              ...
              <div className='text-center p-4 bg-gray-50 rounded-lg'>
                <div className='text-3xl font-bold text-gray-900'>
                  {metrics.system.totalConversations}
                </div>
              ...
              <div className='text-center p-4 bg-gray-50 rounded-lg'>
                <div className='flex items-center justify-center gap-1'>
                  ...
                  <div className='text-3xl font-bold text-gray-900'>
                    {metrics.system.avgRating.toFixed(1)}
                  </div>
                </div>
        ...
        <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
          ...
          <Card
            className='hover:shadow-lg transition-shadow cursor-pointer'
            onClick={() => (window.location.href = '/AdminBookings')}
          >
            <CardContent className='p-4 text-center'>
          ...
          <Card
            className='hover:shadow-lg transition-shadow cursor-pointer'
            onClick={() => (window.location.href = '/AdminAnalytics')}
          >
            <CardContent className='p-4 text-center'>
          ...
          <DialogContent className='max-w-4xl max-h-[90vh] overflow-y-auto'>
            ...
            <div className='space-y-4'>
              ...
              <div className='grid grid-cols-2 gap-4'>
                ...
                <div>
                  ...
                  <p className='font-semibold'>
                    {format(new Date(selectedBooking.created_date), 'MMM d, yyyy HH:mm')}
                  </p>
                </div>
              </div>
              ...
              <div className='bg-blue-50 p-4 rounded-lg'>
                ...
                <p>
                  <strong>Email:</strong> {selectedBooking.traveler_email}
                </p>
                {getBookingTraveler(selectedBooking) && (
                  <>
                    <p>
                      <strong>Name:</strong> {getBookingTraveler(selectedBooking).full_name}
                    </p>
                    {getBookingTraveler(selectedBooking).phone && (
                      <p>
                        <strong>Phone:</strong> {getBookingTraveler(selectedBooking).phone}
                      </p>
                    )}
                  </>
                )}
              ...
              {selectedBooking.host_email && getBookingHost(selectedBooking) && (
                <div className='bg-green-50 p-4 rounded-lg'>
                  ...
                  <p>
                    <strong>Name:</strong> {getBookingHost(selectedBooking).full_name}
                  </p>
                  {getBookingHost(selectedBooking).phone && (
                    <p>
                      <strong>Phone:</strong> {getBookingHost(selectedBooking).phone}
                    </p>
                  )}
                </div>
              )}
              ...
              <div className='bg-gray-50 p-4 rounded-lg'>
                ...
                <div className='grid grid-cols-2 gap-3'>
                  ...
                  <div>
                    ...
                    <p className='font-semibold'>
                      {format(new Date(selectedBooking.start_date), 'MMM d')} -{' '}
                  ...
                  <div>
                    ...
                    <p className='font-semibold'>
                      ...
                      {selectedBooking.number_of_children > 0 &&
                    ...
                    {getBookingOffers(selectedBooking.id).map((offer) => (
                      <div key={offer.id} className='border p-3 rounded-lg'>
                        ...
                        <p className='text-sm text-gray-600'>
                          Price: ${offer.price_total || offer.price_base}
                        </p>
              ...
              <div className='flex gap-2'>
                <Button
                  variant='outline'
                  onClick={() => (window.location.href = `/AdminBookings?id=${selectedBooking.id}`)}
                >
                  View Full Details
                </Button>
                {getBookingConversation(selectedBooking.id) && (
                  <Button
                    variant='outline'
                    onClick={() =>
                      (window.location.href = `/AdminMessages?conversation_id=${
                        getBookingConversation(selectedBooking.id).id
                      }`)
                    }
                  >
