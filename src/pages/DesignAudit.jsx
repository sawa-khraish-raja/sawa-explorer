...
export default function DesignAudit() {
  ...
  const audit = {
    ...
    typography: {
      score: 65,
      issues: [
        { severity: 'high', page: 'Header Mobile', issue: 'h-20 كبير جداً للموبايل - المعيار h-14 إلى h-16', fix: 'تصغير إلى h-16' },
        { severity: 'high', page: 'Header Icons', issue: 'الأيقونات w-6 h-6 كبيرة - المعيار w-5 h-5', fix: 'تصغير إلى w-5 h-5' },
        { severity: 'medium', page: 'Profile Photo', issue: 'w-10 h-10 كبيرة للـ header - المعيار w-8 h-8', fix: 'تصغير إلى w-8 h-8' },
        { severity: 'medium', page: 'Home Hero', issue: 'Hero title كبير جداً على الموبايل', fix: 'استخدم text-2xl بدل text-3xl' },
        { severity: 'low', page: 'Cards', issue: 'بعض الـ card titles غير متناسقة', fix: 'توحيد بين text-lg و text-xl' },
      ],
      goodPractices: [
    ...
    spacing: {
      score: 70,
      issues: [
        { severity: 'high', page: 'Mobile Header', issue: 'h-20 (80px) كبير - يأخذ مساحة كبيرة من الشاشة', fix: 'تصغير إلى h-16 (64px)' },
        { severity: 'high', page: 'Header Icons Gap', issue: 'gap-2 بين الأيقونات قليل جداً - صعب النقر', fix: 'gap-3 أو gap-4' },
        { severity: 'medium', page: 'Cards Padding', issue: 'بعض الكروت p-6 وبعضها p-4', fix: 'توحيد بين p-4 و p-5' },
        { severity: 'medium', page: 'Section Spacing', issue: 'py-12 و py-8 غير متناسقين', fix: 'py-8 للموبايل، py-12 للـ Desktop' },
        { severity: 'low', page: 'Button Padding', issue: 'بعض الأزرار px-4 وبعضها px-6', fix: 'توحيد px-4 للصغير، px-6 للكبير' },
      ],
      goodPractices: [
    ...
    iconSizes: {
      score: 60,
      issues: [
        { severity: 'high', page: 'Header Mobile', issue: 'w-6 h-6 للأيقونات كبيرة - المعيار w-5 h-5', fix: 'تصغير إلى w-5 h-5' },
        { severity: 'high', page: 'Logo Size', issue: 'Logo w-12 h-12 كبير للموبايل - المعيار w-10 h-10', fix: 'تصغير إلى w-10 h-10' },
        { severity: 'medium', page: 'Button Icons', issue: 'أيقونات الأزرار غير متناسقة - بعضها w-4 وبعضها w-5', fix: 'توحيد w-4 h-4' },
        { severity: 'medium', page: 'Dashboard Icons', issue: 'w-6 h-6 للـ dashboard - يفضل w-5 h-5', fix: 'تصغير قليلاً' },
      ],
      goodPractices: [
        '✅ استخدام w-* h-* بدل size-*',
        '✅ تناسق في الأحجام داخل نفس الـ component'
      ],
      recommendations: [
    ...
    buttons: {
      score: 75,
      issues: [
        { severity: 'medium', page: 'Header Buttons', issue: 'w-12 h-12 كبيرة - المعيار w-10 h-10', fix: 'تصغير إلى w-10 h-10' },
        { severity: 'medium', page: 'Primary CTAs', issue: 'بعض الأزرار h-12 وبعضها h-11', fix: 'توحيد h-10 أو h-11' },
        { severity: 'low', page: 'Secondary Buttons', issue: 'rounded-full و rounded-xl مختلط', fix: 'توحيد rounded-xl' },
      ],
      goodPractices: [
        '✅ hover states واضحة',
        '✅ disabled states موجودة',
    ...
    colors: {
      score: 85,
      issues: [
        { severity: 'low', page: 'Text Colors', issue: 'text-gray-600 و text-gray-700 مختلطين', fix: 'text-gray-700 للأساسي، text-gray-600 للثانوي' },
        { severity: 'low', page: 'Borders', issue: 'border-gray-200 و border-gray-100 غير متناسقين', fix: 'border-gray-200 للحدود الواضحة' },
      ],
      goodPractices: [
    ...
    responsive: {
      score: 80,
      issues: [
        { severity: 'medium', page: 'Header Height', issue: 'h-20 على الموبايل يأخذ مساحة كبيرة', fix: 'h-16 أفضل للموبايل' },
        { severity: 'medium', page: 'Text Sizes', issue: 'بعض النصوص كبيرة على الموبايل', fix: 'استخدم text-xl sm:text-2xl lg:text-3xl' },
        { severity: 'low', page: 'Spacing', issue: 'بعض الـ sections padding كبير على الموبايل', fix: 'py-8 sm:py-12 lg:py-16' },
      ],
      goodPractices: [
    ...
    containers: {
      score: 75,
      issues: [
        { severity: 'medium', page: 'Card Shadows', issue: 'shadow-lg و shadow-xl مختلطين', fix: 'shadow-md للعادي، shadow-lg للـ hover' },
        { severity: 'medium', page: 'Border Radius', issue: 'rounded-xl و rounded-2xl غير متناسقين', fix: 'rounded-xl للكروت' },
        { severity: 'low', page: 'Card Padding', issue: 'p-4 و p-6 مختلطين', fix: 'p-4 sm:p-6' },
      ],
      goodPractices: [
        '✅ hover:shadow-* للتفاعل',
        '✅ bg-white للكروت',
        '✅ border للتمييز'
      ],
      recommendations: [
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2">
            تقييم التصميم والتناسق
          </h1>
          <p className="text-gray-600">
            تحليل شامل لأحجام المحتويات والتناسق عبر الموقع
          </p>
        </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-4 bg-red-50 rounded-xl border border-red-200">
                  <div className="text-3xl font-bold text-red-600">
                    {Object.values(audit).reduce((acc, cat) => 
                      acc + cat.issues.filter(i => i.severity === 'high').length, 0
                    )}
                  </div>
                ...
                <div className="text-center p-4 bg-yellow-50 rounded-xl border border-yellow-200">
                  <div className="text-3xl font-bold text-yellow-600">
                    {Object.values(audit).reduce((acc, cat) => 
                      acc + cat.issues.filter(i => i.severity === 'medium').length, 0
                    )}
                  </div>
                        ...
                        {data.issues.map((issue, idx) => (
                          <div key={idx} className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                            <div className="flex items-start gap-2 mb-2">
                              ...
                              <span className="text-xs font-semibold text-purple-700">{issue.page}</span>
                            </div>
            ...
            <div className="p-4 bg-orange-50 rounded-xl border border-orange-200">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-orange-700 mb-2">الأيقونات w-6 h-6 كبيرة - المعيار w-5 h-5</p>
            ...
            <div className="p-4 bg-yellow-50 rounded-xl border border-yellow-200">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <code className="text-xs bg-white px-2 py-1 rounded">w-8 h-8 للـ header avatar</code>
                </div>
              </div>
            </div>
