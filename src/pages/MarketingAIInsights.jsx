                    ...
                    >
                      ...
                      <div className="flex items-baseline gap-2">
                        ...
                        <p className="text-xs text-gray-600">
                          {totalUsers > 0 ? ((persona.user_count / totalUsers) * 100).toFixed(0) : 0}%
                        </p>
                      </div>
                  ...
                  {personas.slice(0, 3).map((persona) => (
                    ...
                    >
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <Badge className={`${
                          persona.growth_trend === 'growing' ? 'bg-green-100 text-green-800' :
                          persona.growth_trend === 'declining' ? 'bg-red-100 text-red-800' :
              ...
              <CardContent className="p-6">
                ...
                {latestReport.metrics && (
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    {Object.entries(latestReport.metrics).slice(0, 4).map(([key, value]) => (
