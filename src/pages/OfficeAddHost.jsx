...
import { 
  UserPlus, Loader2, CheckCircle, XCircle, Clock,
  ArrowLeft, AlertCircle, Mail, Phone, MapPin, User
} from 'lucide-react';
                ...
                {requestsLoading ? (
                  ...
                  <div className="space-y-3 max-h-96 overflow-y-auto">
                    {requests.map(request => (
                      <div key={request.id} className="p-3 border rounded-lg bg-white hover:shadow-md transition-shadow">
