  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="prose prose-lg">
        ...
        <p>This Privacy Notice for Khraish & Raja ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:</p>
        <ul>
        <li>Download and use our mobile application (Sawa), or any other application of ours that links to this Privacy Notice</li>
        <li>Engage with us in other related ways, including any sales, marketing, or events</li>
        </ul>
        <p>Questions or concerns? Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at info@sawaapp.io.</p>
        ...
        <p><strong>How do you exercise your rights?</strong> The easiest way to exercise your rights is by visiting https://sawaapp.io/deleted-user-data, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.</p>
        ...
        <p><i>In Short: We offer products, features, or tools powered by artificial intelligence, machine learning, or similar technologies.</i></p>
        ...
        <p>We provide the AI Products through third-party service providers ("AI Service Providers"), including DeepSeek. As outlined in this Privacy Notice, your input, output, and personal information will be shared with and processed by these AI Service Providers to enable your use of our AI Products for purposes outlined in "WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?" You must not use the AI Products in any way that violates the terms or policies of any AI Service Provider.</p>
        <p><strong>Our AI Products</strong></p>
        <p>Our AI Products are designed for the following functions:</p>
        <ul><li>AI applications</li></ul>
        ...
        <p>We do not knowingly collect, solicit data from, or market to children under 18 years of age, nor do we knowingly sell such personal information. By using the Services, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent’s use of the Services. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18, please contact us at k.haif@sawaapp.io.</p>

        <h3>11. WHAT ARE YOUR PRIVACY RIGHTS?</h3>
        <p><i>In Short: Depending on your state of residence in the US or in some regions, such as the European Economic Area (EEA), United Kingdom (UK), Switzerland, and Canada, you have rights that allow you greater access to and control over your personal information. You may review, change, or terminate your account at any time, depending on your country, province, or state of residence.</i></p>
        ...
        <p>If you have questions or comments about your privacy rights, you may email us at info@sawaapp.io.</p>
        ...
        <table className="w-full border-collapse border">
            ...
            <tbody>
                ...
                <tr><td className="border p-2">B. Personal information as defined in the California Customer Records statute</td><td className="border p-2">Name, contact information, education, employment, employment history, and financial information</td><td className="border p-2">NO</td></tr>
                ...
                <tr><td className="border p-2">F. Internet or other similar network activity</td><td className="border p-2">Browsing history, search history, online behavior, interest data, and interactions with our and other websites, applications, systems, and advertisements</td><td className="border p-2">NO</td></tr>
                ...
                <tr><td className="border p-2">L. Sensitive personal Information</td><td className="border p-2"></td><td className="border p-2">NO</td></tr>
            </tbody>
        </table>
        ...
        <ul><li>Category H - As long as the user has an account with us</li></ul>
        ...
        <p>To exercise these rights, you can contact us by visiting https://sawaapp.io/deleted-user-data, by emailing us at sawa.khraish.raja@gmail.com, by visiting https://sawaapp.io/contact, or by referring to the contact details at the bottom of this document.</p>
        ...
        <p>Under certain US state data protection laws, if we decline to take action regarding your request, you may appeal our decision by emailing us at info@sawaapp.io. We will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may submit a complaint to your state attorney general.</p>
        ...
        <p><i>In Short: You may have additional rights based on the country you reside in.</i></p>
        ...
        Complaints (complete POPIA/PAIA form 5): PAIAComplaints@inforegulator.org.za & POPIAComplaints@inforegulator.org.za</p>
        ...
        <p>If you have questions or comments about this notice, you may contact our Data Protection Officer (DPO) by email at k.haif@sawaapp.io, by phone at +213770008502, or contact us by post at:</p>
        <p>Khraish & Raja<br/>
        Data Protection Officer<br/>
        Walddörferstr. 157<br/>
        Hamburg, Hamburg 22047<br/>
        Germany</p>
        <p>If you are a resident in the European Economic Area, we are the "data controller" of your personal information. We have appointed Khraish & Raja UG to be our representative in the EEA. You can contact them directly regarding our processing of your information, by email at info@sawaapp.io, by visiting sawaapp.io, by phone at +49 177 4426 739, or by post to:</p>
        <p>Walddörferstr. 157, 22047 Hamburg, Germany<br/>
        Hamburg<br/>
        Germany</p>

        <h3>17. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h3>
        <p>You have the right to request access to the personal information we collect from you, details about how we have processed it, correct inaccuracies, or delete your personal information. You may also have the right to withdraw your consent to our processing of your personal information. These rights may be limited in some circumstances by applicable law. To request to review, update, or delete your personal information, please visit: https://sawaapp.io/deleted-user-data.</p>
      </div>
    </div>
  );
}