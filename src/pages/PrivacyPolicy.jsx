  ...
  return (
    <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
      <div className='prose prose-lg'>
        ...
        <p>
          This Privacy Notice for Khraish & Raja ("we," "us," or "our"), describes how and why we
        ...
        <ul>
          <li>
            Download and use our mobile application (Sawa), or any other application of ours that
        ...
        <p>
          ...
          is by visiting https://sawaapp.io/deleted-user-data, or by contacting us. We will consider
        ...
        <p>
          ...
          Stripe. You may find their privacy notice link(s) here: https://stripe.com/privacy.
        </p>
        <p>
        ...
        <ul>
          <li>
            <strong>Mobile Device Data.</strong> We automatically collect device information (such
            ...
            numbers, browser type and version, hardware model Internet service provider and/or
            mobile carrier, and Internet Protocol (IP) address (or proxy server). If you are using
            our application(s), we may also collect information about the phone network associated
          ...
          <li>
            ...
            regarding your account or certain features of the application(s). If you wish to opt out
            from receiving these types of communications, you may turn them off in your device's
            settings.
          </li>
        </ul>
        <p>
        ...
        <ul>
          <li>
            ...
            can withdraw your consent at any time. Learn more about withdrawing your consent.
          </li>
          <li>
        ...
        <p>
          ...
          of the personal information described in this Privacy Notice, since we determine the means
          ...
          information, and we merely process your information on their behalf in accordance with
          your instructions. If you want to know more about our customers' privacy practices, you
        ...
        <ul>
          ...
          <li>
            ...
            with other users of our Services and register for our Services through a social network
            (such as Facebook), your contacts on the social network will see your name, profile
        ...
        <p>
          ...
          Analytics Demographics and Interests Reporting and Google Display Network Impressions
          ...
          http://optout.networkadvertising.org/ and http://www.networkadvertising.org/mobile-choice.
        ...
        <p>
          ...
          including DeepSeek. As outlined in this Privacy Notice, your input, output, and personal
          information will be shared with and processed by these AI Service Providers to enable your
          use of our AI Products for purposes outlined in "WHAT LEGAL BASES DO WE RELY ON TO PROCESS
          YOUR PERSONAL INFORMATION?" You must not use the AI Products in any way that violates the
        ...
        <p>
          ...
          contact us at k.haif@sawaapp.io.
        </p>
        ...
        <p>
          ...
          https://sawaapp.io/deleted-user-data, by emailing us at sawa.khraish.raja@gmail.com, by
          visiting https://sawaapp.io/contact, or by referring to the contact details at the bottom
          of this document.
        </p>
        <p>
        ...
        <p>
          ...
          request, you may appeal our decision by emailing us at info@sawaapp.io. We will inform you
        ...
        <p>
          <i>In Short: You may have additional rights based on the country you reside in.</i>
        </p>
        <p>
          <strong>Australia and New Zealand</strong>
        </p>
        <p>
          We collect and process your personal information under the obligations and conditions set
          by Australia's Privacy Act 1988 and New Zealand's Privacy Act 2020 (Privacy Act).
        </p>
        <p>
        ...
        <p>
          ...
          information. You can make such a request by contacting us by using the contact details
          provided in the section "HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM
          YOU?"
        </p>
        <p>
          If you believe we are unlawfully processing your personal information, you have the right
          to submit a complaint about a breach of the Australian Privacy Principles to the Office of
          the Australian Information Commissioner and a breach of New Zealand's Privacy Principles
        ...
        <p>
          ...
          Officer (DPO) by email at k.haif@sawaapp.io, by phone at +213770008502, or contact us by
          post at:
        </p>
        <p>
          Khraish & Raja
        ...
        <p>
          ...
          personal information. We have appointed Khraish & Raja UG to be our representative in the
          EEA. You can contact them directly regarding our processing of your information, by email
          at info@sawaapp.io, by visiting sawaapp.io, by phone at +49 177 4426 739, or by post to:
        </p>
        <p>
          Walddörferstr. 157, 22047 Hamburg, Germany
          <br />
          Hamburg
          <br />
          Germany
        ...
        <p>
          ...
          https://sawaapp.io/deleted-user-data.
        </p>
      </div>
    </div>
  );
