            ...
            <CardContent>
              <div className='grid grid-cols-3 gap-4'>
                ...
                <div>
                  ...
                  <Badge
                    className={
                      aiStatus.config.autoheal_enabled
                ...
                <div>
                  ...
                  <span className='font-bold text-gray-900'>
                    {aiStatus.config.threshold} errors
                  </span>
                </div>
              </div>
            </CardContent>
              ...
              <div className='space-y-4'>
                <div className='flex items-center justify-between'>
                  <div>
                    ...
                    <Badge
                      className={`${getRiskColor(aiStatus.analysis.risk)} text-lg px-4 py-2 border-2`}
                    >
                  ...
                  <div>
                    ...
                    <div
                      className={`text-4xl font-bold ${getSeverityColor(aiStatus.analysis.severity)}`}
                    >
                ...
                {aiStatus.analysis.recommended_actions &&
                  aiStatus.analysis.recommended_actions.length > 0 && (
                    <div>
