  ...
  const notificationTemplates = [
    {
      ...
      message: 'Start your journey by exploring amazing destinations and connecting with local hosts.',
      link: '/Home',
                      ...
                      >
                        ...
                        <div className="relative">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="font-semibold text-sm text-gray-900">{template.type.charAt(0).toUpperCase() + template.type.slice(1)}</span>
                          </div>
                      ...
                      <div className="bg-white rounded-xl p-4 shadow-md border border-gray-200">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <h4 className="font-bold text-sm text-gray-900 mb-1">{title || 'Title'}</h4>
                            <p className="text-xs text-gray-600 leading-relaxed">{message || 'Message'}</p>
                            {link && (
                              <div className="mt-2">
