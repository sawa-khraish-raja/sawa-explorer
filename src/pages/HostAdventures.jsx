...
export default function HostAdventures() {
  ...
  const { data: adventures = [], isLoading: adventuresLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return allAdventures.filter(a => a.host_email === user.email && a.added_by_type !== 'office');
    },
    enabled: !!user?.email,
  ...
  const saveAdventureMutation = useMutation({
    mutationFn: async (adventureData) => {
      const hostType = user.host_type === 'office' ? 'office_host' : 'freelancer';
      ...
      const dataToSave = {
        ...
        commission_breakdown: {
          ...
          office_percent: commissions.officePercent || 0,
          office_amount: commissions.officeAmount || 0,
    ...
    onSuccess: () => {
      ...
      toast.success(editingAdventure ? 'Adventure updated!' : 'Adventure created! Pending admin approval.');
    },
    onError: (error) => {
  ...
  const filteredAdventures = activeTab === 'all' ? adventures :
          ...
          <div className="bg-gradient-to-r from-[#7B2CBF] to-[#9D4EDD] p-8 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-purple-100">Create and manage unique experiences for travelers</p>
              </div>
              <Button
                onClick={() => {
                  setEditingAdventure(null);
            ...
            {filteredAdventures.length === 0 ? (
              <Card>
                <CardContent className="text-center py-12">
                  ...
                  <p className="text-gray-500 mt-2 mb-4">Create your first adventure experience</p>
                  <Button
                  ...
                  <Card key={adventure.id} className="hover:shadow-lg transition-shadow">
                    ...
                    <CardContent className="p-5">
                      ...
                      <div className="space-y-2 mb-4">
                        ...
                        <div className="flex items-center gap-2 text-sm text-gray-600">
                          <DollarSign className="w-4 h-4 text-[#7B2CBF]" />
                          ${adventure.host_price} (You receive)
                        </div>
                      </div>
        ...
        <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>
                {editingAdventure 
                  ...
                  : 'Create a unique adventure for travelers. Your adventure will need admin approval before going live.'
                }
              </DialogDescription>
            </DialogHeader>
            ...
            <AdventureForm
              ...
              hostType={user.host_type === 'office' ? 'office' : 'freelancer'}
        ...
        <AlertDialog open={!!deleteConfirmId} onOpenChange={() => setDeleteConfirmId(null)}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This action cannot be undone. This will permanently delete the adventure and all related data.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
