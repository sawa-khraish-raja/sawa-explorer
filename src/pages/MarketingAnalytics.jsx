...
export default function MarketingAnalytics() {
  ...
  const analytics = useMemo(() => {
    ...
    const confirmedBookingsArray = bookings.filter(b => b.status === 'confirmed' || b.state === 'confirmed');
    const confirmedBookingsCount = confirmedBookingsArray.length;
    const conversionRate = bookings.length > 0 ? (confirmedBookingsCount / bookings.length * 100) : 0;

    // Revenue metrics
    const revenueThisMonth = bookings
      .filter(b => (b.status === 'confirmed' || b.state === 'confirmed') && new Date(b.created_date) >= startOfMonth)
      .reduce((sum, b) => sum + (b.total_price || 0), 0);

    const avgBookingValue = confirmedBookingsCount > 0 
      ? confirmedBookingsArray.reduce((sum, b) => sum + (b.total_price || 0), 0) / confirmedBookingsCount
      : 0;

    // Conversation metrics
    const activeConversations = conversations.filter(c => 
      c.last_message_timestamp && new Date(c.last_message_timestamp) > last7Days
    ).length;
    ...
    const calculateSawaRevenue = () => {
      ...
      confirmedBookingsArray.forEach(booking => {
        ...
        if (bookingOffer && bookingOffer.sawa_commission !== undefined && bookingOffer.sawa_commission !== null) {
        ...
        } else if (bookingOffer && bookingOffer.host_price !== undefined && bookingOffer.host_price !== null) {
            ...
            {analyticsData && (
              <div className="mt-4">
                <Badge className="bg-white/20 text-white border-0">
                  ...
                  Google Analytics: {analyticsData.data_source === 'combined' ? 'Connected' : 'Internal Data Only'}
                </Badge>
              </div>
            )}
          </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <div className="text-3xl font-bold">${analytics.sawaRevenue.total.toFixed(0)}</div>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <div className="text-3xl font-bold text-purple-600">${analytics.sawaRevenue.officeHost.toFixed(0)}</div>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <div className="text-3xl font-bold text-blue-600">${analytics.sawaRevenue.independent.toFixed(0)}</div>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="border-l-4 border-l-blue-500">
              <CardContent className="p-6">
                ...
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="text-green-600 font-semibold">+{analytics.newUsersLast7Days}</span>
            ...
            <Card className="border-l-4 border-l-green-500">
              <CardContent className="p-6">
                ...
                <div className="flex items-center gap-2 text-sm">
                  <TrendingUp className="w-4 h-4 text-green-600" />
                  <span className="text-green-600 font-semibold">+{analytics.bookingsLast7Days}</span>
                  <span className="text-gray-500">last 7 days</span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-l-4 border-l-purple-500">
              <CardContent className="p-6">
                ...
                <p className="text-3xl font-bold text-gray-900 mb-2">${analytics.revenueThisMonth.toFixed(0)}</p>
                <div className="flex items-center gap-2 text-sm">
            ...
            <Card className="border-l-4 border-l-orange-500">
              <CardContent className="p-6">
                ...
                <p className="text-3xl font-bold text-gray-900 mb-2">{analytics.activeConversations}</p>
                <div className="flex items-center gap-2 text-sm">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center">
                  <p className="text-5xl font-bold text-[var(--brand-primary)] mb-2">{analytics.conversionRate.toFixed(1)}%</p>
                  ...
                  {analytics.topCities.map((city) => (
                    <div key={city.city} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600">{city.confirmed} confirmed of {city.total} bookings</p>
                      </div>
                      <div className="text-right">
                        <p className="text-lg font-bold text-green-600">${city.revenue.toFixed(0)}</p>
