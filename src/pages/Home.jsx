...
export default function Home() {
  ...
  return (
    <div className='bg-white overflow-x-hidden'>
      ...
      <section
        id='search-bar-home'
        className='relative h-[85vh] sm:h-[90vh] lg:h-[95vh] overflow-hidden bg-black'
      >
        ...
        <div className='relative z-10 flex flex-col items-center justify-center h-full w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <div className='text-center mb-8 sm:mb-10 lg:mb-12'>
            <h1 className='text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight tracking-tight mb-4 sm:mb-6'>
              {language === 'ar' ? (
                <span className='text-white drop-shadow-2xl'>بهجة الحياة المحلية</span>
              ) : (
                <span className='text-white drop-shadow-2xl'>Local Life's Joy</span>
              )}
            </h1>
