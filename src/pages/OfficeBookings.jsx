    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 py-8">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-6 flex items-center gap-4">
          ...
          <h1 className="text-3xl font-bold text-gray-900">All Bookings ({officeBookings.length})</h1>
        </div>
        ...
        {officeBookings.length === 0 ? (
          <Card className="text-center py-16">
            <CardContent>
              ...
              <p className="text-gray-600">Bookings will appear here once travelers make requests</p>
            </CardContent>
          </Card>
        ) : (
          <div className="space-y-4">
            {officeBookings.map((booking) => {
              ...
              return (
                <Card key={booking.id} className="border-l-4 border-l-purple-500 hover:shadow-lg transition-shadow">
