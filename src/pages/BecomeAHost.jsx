      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#E6E6FF] via-white to-[#CCCCFF] p-4">
        <Card className="w-full max-w-lg text-center shadow-2xl p-8">
          <CardContent>
            ...
            <p className="text-gray-600">Your request to become a host has been received. Our team will review it and get back to you soon.</p>
          </CardContent>
        </Card>
      </div>
    );
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input id="host_full_name" name="host_full_name" value={formData.host_full_name} onChange={handleChange} required />
                  </div>
                  <div>
                    <Label htmlFor="host_email">Email</Label>
                    <Input id="host_email" name="host_email" type="email" value={formData.host_email} onChange={handleChange} required />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input id="host_phone" name="host_phone" value={formData.host_phone} onChange={handleChange} required />
                  </div>
                  <div>
                    <Label htmlFor="host_whatsapp">WhatsApp (Optional)</Label>
                    <Input id="host_whatsapp" name="host_whatsapp" value={formData.host_whatsapp} onChange={handleChange} />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Select name="host_city" onValueChange={(value) => handleSelectChange('host_city', value)} required>
                      <SelectTrigger>
                  ...
                  <div>
                    ...
                    <Input id="experience_years" name="experience_years" type="number" value={formData.experience_years} onChange={handleChange} />
                  </div>
                </div>

                <div>
                  <Label htmlFor="languages">Languages (comma-separated)</Label>
                  <Input id="languages" name="languages" value={formData.languages} onChange={handleChange} placeholder="e.g. Arabic, English" />
                </div>

                <div>
                  <Label htmlFor="host_bio">About You</Label>
                  <Textarea id="host_bio" name="host_bio" value={formData.host_bio} onChange={handleChange} rows={4} placeholder="Tell us about yourself and why you want to be a host." required />
                </div>

                <Button type="submit" disabled={createHostRequestMutation.isPending} className="w-full bg-gradient-to-r from-[var(--brand-primary)] to-[var(--brand-secondary)] text-white text-lg py-3">
