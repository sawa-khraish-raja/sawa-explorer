...
import { 
  Briefcase, Search, Filter, Calendar, Mail, Phone, Building2,
  CheckCircle2, XCircle, Clock, MessageSquare, User, ArrowRight,
  TrendingUp, Users, FileText, AlertCircle, Eye, Edit, Loader2
} from 'lucide-react';
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-3 mb-2">
                              <h3 className="text-lg font-bold text-gray-900">{request.organization_name}</h3>
                            ...
                            {request.admin_notes && (
                              <div className="mt-2 p-3 bg-blue-50 rounded-lg border-l-4 border-blue-500">
                                ...
                                <p className="text-sm text-blue-800 line-clamp-1">{request.admin_notes}</p>
                              </div>
                            )}
                          </div>
                        </div>
        ...
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          ...
          {selectedRequest && (
            <div className="space-y-6 py-4">
              {/* Status Badge */}
              <div className="flex items-center justify-between">
                <Badge className={cn('text-base px-4 py-2 border', getStatusConfig(selectedRequest.status).color)}>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="font-semibold text-gray-900">{selectedRequest.organization_name}</p>
                    </div>
                    <div>
