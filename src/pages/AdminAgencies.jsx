...
import { 
  ...
  MapPin, Phone, Mail, Search, Loader2, Eye, AlertCircle
} from 'lucide-react';
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-4">
          {filteredAgencies.map(agency => {
            ...
            return (
              <Card key={agency.id} className={`${!agency.is_active ? 'opacity-60' : ''} hover:shadow-lg transition-shadow`}>
                <CardContent className="p-6">
                  <div className="flex flex-col lg:flex-row gap-4 justify-between">
                      ...
                      <div className="flex items-start gap-3 mb-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            <Badge className={agency.is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-3 text-sm text-gray-600">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <span>{hostsCount} host{hostsCount !== 1 ? 's' : ''}</span>
                            </div>
                          </div>
                    ...
                    <div className="flex lg:flex-col gap-2 lg:w-auto w-full">
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() => toggleAgencyStatusMutation.mutate({
                          agencyId: agency.id,
            ...
            <Card>
              <CardContent className="py-12 text-center">
                ...
                <p className="text-gray-600">
                  {searchTerm ? 'Try a different search term' : 'Create your first agency to get started'}
                </p>
              </CardContent>
            </Card>
          )}
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="bg-indigo-50 p-4 rounded-lg border border-indigo-200">
              <h4 className="font-semibold text-sm text-indigo-900 mb-2">Default Commission Rates:</h4>
          ...
          <DialogFooter>
            ...
            >
              {createAgencyMutation.isPending ? (
                ...
                <><Plus className="w-4 h-4 mr-2" />Create Agency</>
              )}
            </Button>
          </DialogFooter>
        </DialogContent>
