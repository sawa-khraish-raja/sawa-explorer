                  ...
                  <CardContent className='p-6'>
                    <div className='space-y-4'>
                      {plan.key_opportunities.map((opp, idx) => (
                        <div
                          key={idx}
                          className='p-5 bg-green-50 rounded-lg border-l-4 border-green-600'
                        >
                  ...
                  <CardContent className='p-6'>
                    <div className='text-center p-6 bg-gradient-to-br from-green-50 to-white rounded-xl border-2 border-green-200 mb-6'>
                      ...
                      <p className='text-sm text-gray-500'>
                        {(
                          (plan.predicted_revenue / (plan.predicted_revenue / 1.15 || 1) - 1) *
                          100
                        ).toFixed(1)}
                        % growth projected
                      </p>
                      ...
                      <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                        {plan.revenue_breakdown.by_city && (
                          <div>
                            ...
                            <div className='space-y-2'>
                              {Object.entries(plan.revenue_breakdown.by_city).map(
                                ([city, revenue]) => (
                                  <div
                                    key={city}
                        ...
                        {plan.revenue_breakdown.by_persona && (
                          <div>
                            ...
                            <div className='space-y-2'>
                              {Object.entries(plan.revenue_breakdown.by_persona).map(
                                ([persona, revenue]) => (
                                  <div
                                    key={persona}
                                    className='flex justify-between items-center p-3 bg-gray-50 rounded-lg'
                  ...
                  <CardContent className='p-6'>
                    <div className='space-y-4'>
                      {plan.ai_risk_assessment.map((risk, idx) => (
                        <div
                          key={idx}
                          className='p-5 bg-red-50 rounded-lg border-l-4 border-red-600'
                        >
                          <div className='flex items-start justify-between mb-3'>
