...
import { 
  MapPin, Star, Calendar, Users, MessageSquare, Award, 
  Camera, ChefHat, BookOpen, Palette, Mountain, ShieldCheck,
  CheckCircle, Globe, Phone, Mail, Instagram, Facebook,
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white flex items-center justify-center">
        <Card className="max-w-md">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-600 mb-4">This host profile doesn't exist or is no longer available.</p>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <p className="text-gray-700 leading-relaxed whitespace-pre-wrap">
                        {host.about_me || host.bio || `${getUserDisplayName(host)} is a verified local host in ${normalizeText(host.city)}.`}
                      </p>
                      ...
                      <CardContent>
                        <div className="flex flex-wrap gap-2">
                          {host.skills.map((skill, idx) => (
                            <Badge key={idx} className="bg-indigo-100 text-indigo-900 hover:bg-indigo-200">
                              {skill}
                            </Badge>
                          ))}
                        </div>
                      ...
                      <CardContent>
                        <div className="space-y-4">
                          {host.certifications.map((cert, idx) => (
                            <div key={idx} className="flex items-start gap-4 p-4 bg-white border rounded-lg">
                              {cert.badge_url && (
                                <img
                                  src={cert.badge_url}
                                  alt={cert.name}
                ...
                <CardContent className="space-y-3">
                  ...
                  {host.years_of_experience && (
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-bold text-gray-900">{host.years_of_experience} years</span>
                    </div>
                  )}
                </CardContent>
              </Card>
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      <div className="flex items-center gap-2 text-sm text-gray-900 font-medium">
                        ...
                        {normalizeText(host.city)} <Badge variant="outline" className="text-xs">Primary</Badge>
                      </div>
