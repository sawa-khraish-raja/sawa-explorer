      ...
      <MarketingLayout>
        <div className='space-y-6'>
          <div className='bg-gradient-to-r from-gray-700 to-gray-900 rounded-2xl p-8 text-white shadow-xl'>
            ...
            <p className='text-gray-300 text-lg'>Configure marketing dashboard preferences</p>
          </div>
            ...
            <Card className='shadow-xl md:col-span-2'>
              ...
              <CardContent>
                <div className='bg-green-50 border-2 border-green-200 rounded-xl p-4'>
                  <p className='text-sm text-green-900 font-semibold mb-2'>Mirror Status: Active</p>
                  <p className='text-sm text-gray-700'>
                    All platform data is mirrored in real-time with read-only access. No write
                    operations are allowed on the mirror layer.
                  </p>
                </div>
              </CardContent>
            </Card>
