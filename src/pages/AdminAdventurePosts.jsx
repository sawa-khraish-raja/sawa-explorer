      ...
      <div className="relative aspect-square">
        {post.media_urls && post.media_urls[0] && (
          post.media_urls[0].type === 'video' ? (
            <video src={post.media_urls[0].url} className="w-full h-full object-cover" muted loop playsInline />
          ) : (
            <img src={post.media_urls[0].url} alt={post.title} className="w-full h-full object-cover" />
          )
        )}
      ...
      <div className="space-y-6">
        ...
        <Dialog open={showDialog} onOpenChange={setShowDialog}>
          <DialogContent>
            <DialogHeader>
              <DialogTitle>
                {action === 'approved' ? 'Approve Post' : 'Reject Post'}
              </DialogTitle>
            </DialogHeader>
