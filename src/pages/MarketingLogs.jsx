...
export default function MarketingLogs() {
  const { data: logs = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return allLogs.sort((a, b) => new Date(b.created_date) - new Date(a.created_date)).slice(0, 100);
    },
  });
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-gray-700 to-gray-900 rounded-2xl p-8 text-white shadow-xl">
            ...
            <p className="text-gray-300 text-lg">
              Audit trail of all marketing data access
            </p>
          </div>
                          ...
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-sm text-gray-600">
                                Action: <span className="font-medium">{details.action || 'N/A'}</span>
                                {details.entity && (
