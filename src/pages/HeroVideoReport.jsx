...
export default function HeroVideoReport() {
  ...
  const generateReport = () => {
    ...
    if (slides.some(s => (s.display_duration || 10) > 25)) report.issues.push('⚠️ Video duration too long (>25s)');
        ...
        <Card className="mb-6 border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-white">
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold text-gray-700 mb-1">Overall Performance Score</h3>
                <p className="text-sm text-gray-500">Based on configuration and real-time metrics</p>
              </div>
            ...
            {overallScore < 70 && (
              <div className="mt-4 p-4 bg-red-50 border border-red-200 rounded-lg flex items-start gap-3">
                ...
                <div className="text-sm text-red-800">
                  <strong>Critical Issues Detected!</strong> Your score is below 70. Immediate action required to prevent mobile crashes.
                </div>
              </div>
            )}
          </CardContent>
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <span className={`text-2xl font-bold ${
                    ...
                    metrics.fps.current >= 30 ? 'text-yellow-600' : 'text-red-600'
                  }`}>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-lg font-semibold text-gray-700">{metrics.fps.lowest} fps</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Average:</span>
                  <span className="text-lg font-semibold text-gray-700">{metrics.fps.average} fps</span>
                </div>
            ...
            <CardContent>
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Current:</span>
                  <span className={`text-2xl font-bold ${
                    currentMemory < 150 ? 'text-green-600' :
                    currentMemory < 200 ? 'text-yellow-600' : 'text-red-600'
                  }`}>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-lg font-semibold text-gray-700">{metrics.memory.peak} MB</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Average:</span>
                  <span className="text-lg font-semibold text-gray-700">{metrics.memory.average} MB</span>
                </div>
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <AssessmentItem
                  ...
                  status={metrics.fps.lowest >= 55 ? 'good' : metrics.fps.lowest >= 30 ? 'medium' : 'bad'}
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-red-800 mb-2">
                        {slides.length} videos detected. Optimal configuration is 1 video for performance. This WILL cause crashes on mobile devices.
                      </p>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-yellow-800 mb-2">
                        One or more videos exceed the recommended 25-second duration. Long videos consume more memory and data.
                      </p>
                      <div className="bg-white p-3 rounded border border-yellow-200">
                        <p className="text-sm font-semibold text-yellow-900 mb-1">Recommendations:</p>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <div className="bg-white p-3 rounded border border-orange-200">
                        <p className="text-sm font-semibold text-orange-900 mb-1">Recommended Actions:</p>
                ...
                <div className="border-l-4 border-yellow-500 pl-4 py-2 bg-yellow-50">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <div className="bg-white p-3 rounded border border-yellow-200">
                        <p className="text-sm font-semibold text-yellow-900 mb-1">Optimization Steps:</p>
                        <ul className="text-sm text-yellow-800 space-y-1">
                    ...
                    <div>
                      ...
                      <div className="bg-white p-3 rounded border border-blue-200">
                        <p className="text-sm text-blue-800">
                          Add poster_image for instant visual display while videos load. Extract first frame from videos.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-800">
                        No critical issues detected. Continue monitoring performance on real devices.
                      </p>
                    </div>
                  </div>
                </div>
