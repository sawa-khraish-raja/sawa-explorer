...
import { Loader2, TrendingUp, TrendingDown, Users, DollarSign, Calendar, MessageSquare, Sparkles, Building2, UserCheck } from 'lucide-react';
...
export default function AdminAnalytics() {
  ...
  const conversionRate = bookings.length > 0 ? (confirmedBookingsCount / bookings.length * 100).toFixed(1) : 0;
  ...
  bookings.forEach(booking => {
    if (booking.city) { // Ensure city exists
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <div className="text-3xl font-bold text-purple-600">${sawaRevenueBreakdown.officeHost.toFixed(0)}</div>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <div className="text-3xl font-bold text-blue-600">${sawaRevenueBreakdown.independent.toFixed(0)}</div>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="border-l-4 border-l-purple-500">
            <CardContent className="p-6">
              ...
              <p className="text-3xl font-bold text-gray-900 mb-2">${revenueThisMonth.toFixed(0)}</p>
              <div className="flex items-center gap-2 text-sm">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center">
                <p className="text-5xl font-bold text-[var(--brand-primary)] mb-2">{conversionRate}%</p>
            ...
            <CardContent>
              <div className="text-center">
                <p className="text-5xl font-bold text-green-600 mb-2">
                  ${confirmedBookingsCount > 0 ? (confirmedBookingsArray.reduce((sum, b) => sum + (b.total_price || 0), 0) / confirmedBookingsCount).toFixed(0) : 0}
                </p>
            ...
            <CardContent>
              <div className="text-center">
                <p className="text-5xl font-bold text-purple-600 mb-2">
                  {users.length > 0 ? ((users.filter(u => u.host_approved).length / users.length) * 100).toFixed(0) : 0}%
                </p>
                ...
                Object.entries(citiesStats).map(([city, stats]) => (
                  <div key={city} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">{stats.confirmed} confirmed of {stats.total} bookings</p>
                    </div>
                    <div className="text-right">
                      <p className="text-lg font-bold text-green-600">${stats.revenue.toFixed(0)}</p>
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
                ...
                <span className="text-lg font-bold text-purple-600">${revenueLast30Days.toFixed(0)}</span>
              </div>
            </div>
          </CardContent>
        </Card>
