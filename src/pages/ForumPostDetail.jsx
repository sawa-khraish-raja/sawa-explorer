...
import {
  Heart, MessageCircle, Share2, ArrowLeft, Loader2,
  Calendar, MapPin, Users, DollarSign, Clock, Tag
} from 'lucide-react';
            ...
            {post.is_adventure_listing && adventure && (
              <Card className="bg-gradient-to-br from-purple-50 to-white border-2 border-purple-200 mb-6">
                <CardContent className="p-6">
                  ...
                  <Button
                    onClick={() => navigate(createPageUrl(`CreateAdventureBooking?adventure_id=${adventure.id}&guests=1`))}
