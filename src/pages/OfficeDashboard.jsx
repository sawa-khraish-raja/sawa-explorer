    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white">
      <div className="max-w-7xl mx-auto p-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-blue-200 mt-1">
                  {currentHosts.length} active host{currentHosts.length !== 1 ? 's' : ''}
                </p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <p className="text-2xl font-bold text-gray-900">{currentHosts.length}</p> {/* Changed from hosts.length */}
              <p className="text-xs text-gray-500 mt-1">Currently assigned</p> {/* Added description */}
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <p className="text-2xl font-bold text-gray-900">{allBookings.length}</p> {/* Changed from bookings.length */}
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="bg-white shadow-md p-1 mb-6">
            ...
            <TabsTrigger value="hosts" className="data-[state=active]:bg-blue-600 data-[state=active]:text-white">
            ...
            <TabsTrigger value="adventures" className="data-[state=active]:bg-blue-600 data-[state=active]:text-white">
            ...
            {currentHosts.length === 0 ? (
              <Card>
                <CardContent className="text-center py-12">
                  ...
                  <p className="text-lg font-semibold text-gray-700">No active hosts</p> {/* Updated text */}
                  <p className="text-gray-500 mt-2 mb-4">Add hosts to your office to start managing bookings</p>
                  <Link to={createPageUrl('OfficeAddHost')}>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4 flex-1">
                        <div className="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center">
                          {host.profile_photo ? (
                            <img src={host.profile_photo} alt="" className="w-full h-full rounded-full object-cover" />
                          ) : (
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-500">{host.email}</p> {/* Added host email */}
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          ...
                          {booking.total_price && (
                            <p className="font-bold text-green-600 mt-2">${booking.total_price.toFixed(2)}</p>
                          )}
                        </div>
                      </div>
                    </CardContent>
                ...
                {hostConversations.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {hostConversations.map(convo => {
                      ...
                      return (
                        <div key={convo.id} className="p-4 border rounded-lg bg-white hover:bg-gray-50 transition-colors">
      ...
      <Dialog open={!!selectedHostMessages} onOpenChange={() => setSelectedHostMessages(null)}>
        <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-4 p-2"> {/* Added some padding */}
