      ...
      <Card className='border-2 border-red-200 bg-red-50'>
        <CardHeader>
          <CardTitle className='flex items-center gap-2 text-red-900'>
            <XCircle className='w-6 h-6' /> المشكلة الحرجة
          </CardTitle>
        </CardHeader>
        <CardContent className='space-y-3 text-sm'>
          <div className='bg-red-100 p-4 rounded-lg border-2 border-red-300'>
            <p className='font-bold text-red-900 mb-2'>المشكلة:</p>
            <p className='text-red-800'>الإشعارات طالعة بـ placeholder text:</p>
  ...
  message: "notification message"     //  Hardcoded placeholder
          ...
          <div>
            ...
            <ul className='list-disc list-inside text-red-800 space-y-1'>
              <li>
                {' '}
                <code>notifyHostsOfNewBooking</code> - شغال صح
              </li>
              <li>
                <code>createOffer</code> - في placeholder
              </li>
              <li>
                <code>chatRelay</code> - ممكن في مشكلة
              </li>
              <li>
                <code>confirmBooking</code> - لازم نتحقق
              </li>
            </ul>
          </div>
        </CardContent>
      ...
      <Card className='border-2 border-yellow-200 bg-yellow-50'>
        ...
        <CardContent className='space-y-4 text-sm'>
          ...
          <div>
            ...
            <p className='text-yellow-800'>ما في testing كافي للإشعارات - حدا ما لاحظ المشكلة</p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className='border-2 border-green-200 bg-green-50'>
        ...
        <CardContent className='space-y-4 text-sm'>
          <div>
            ...
            <p className='text-green-800 mb-2'>إنشاء helper function موحد لكل الإشعارات</p>
  ...
  return base44.asServiceRole.entities.Notification.create({
    ...
    related_offer_id: data.offer_id
          ...
          <div>
            ...
            <p className='text-green-800'>تحديث كل الـ functions لاستخدام الـ helper</p>
          </div>

          <div>
            <Badge className='bg-green-600 mb-2'>Step 3: Add Validation</Badge>
            <p className='text-green-800'>التأكد إن كل notification فيها title & message صحيحين</p>
          </div>

          <div>
            <Badge className='bg-green-600 mb-2'>Step 4: Testing</Badge>
            <p className='text-green-800'>تجربة كل أنواع الإشعارات والتأكد من شغلها</p>
          </div>
        </CardContent>
      </Card>
