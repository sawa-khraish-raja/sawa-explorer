    ...
    <div className='space-y-6'>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Customize which booking updates you want to receive</CardDescription>
        </CardHeader>
        <CardContent className='space-y-4'>
          {user?.host_approved && (
            <>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage message and review notifications</CardDescription>
        </CardHeader>
        <CardContent className='space-y-4'>
          <div className='flex items-center justify-between'>
            <div>
