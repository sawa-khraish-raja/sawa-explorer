    ...
    <div className="space-y-6">
      ...
      <Card className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 shadow-lg">
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            ...
            <Button
              onClick={() => window.open(createPageUrl(`HostProfile?email=${user.email}`), '_blank')}
              size="lg"
      ...
      <Card className="shadow-lg border-2 border-gray-200">
        ...
        <CardContent className="p-6 space-y-4">
          ...
          <div>
            <Label htmlFor="response_time" className="text-sm font-semibold text-gray-700">Response Time (hours)</Label>
            <Input
              id="response_time"
              type="number"
              min="1"
              ...
              onChange={(e) => setProfileData({ ...profileData, response_time_hours: e.target.value })}
              className="mt-2"
            />
          ...
          {user.host_type === 'office' && (
            <div>
              <Label htmlFor="office_name" className="text-sm font-semibold text-gray-700">Office Name *</Label>
              <Input
                id="office_name"
                value={profileData.office_name}
                onChange={(e) => setProfileData({ ...profileData, office_name: e.target.value })}
        ...
        <CardContent className="p-6 space-y-4">
          <div className="flex gap-2">
            <Select value={newLanguage} onValueChange={setNewLanguage}>
              ...
              <SelectContent>
                {AVAILABLE_LANGUAGES.filter(lang => !profileData.languages.includes(lang)).map(lang => (
        ...
        <CardContent className="p-6 space-y-4">
          <div className="flex gap-2">
            <Select value={newService} onValueChange={setNewService}>
              ...
              <SelectContent>
                {AVAILABLE_SERVICES.filter(service => !profileData.services_offered.includes(service)).map(service => (
          ...
          <div className="space-y-2">
            {profileData.services_offered.map(service => (
              <div key={service} className="flex items-center gap-2 p-3 bg-purple-50 rounded-lg border border-purple-100">
