    ...
    <Dialog open={!!host} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="host_status" className="text-right">Status</Label>
            <Select value={formData.host_status} onValueChange={(value) => setFormData(p => ({...p, host_status: value}))}>
                <SelectTrigger className="col-span-3">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Input id="display_order" type="number" value={formData.display_order} onChange={handleInputChange} className="col-span-3" />
          </div>
           <div className="grid grid-cols-4 items-center gap-4">
          ...
          <div className="flex items-center space-x-2 justify-end">
            ...
            <Switch id="show_on_website" checked={formData.show_on_website} onCheckedChange={(checked) => setFormData(p => ({...p, show_on_website: checked}))} />
          </div>
          <div className="flex items-center space-x-2 justify-end">
            <Label htmlFor="is_demo">Is Demo Host</Label>
            <Switch id="is_demo" checked={formData.is_demo} onCheckedChange={(checked) => setFormData(p => ({...p, is_demo: checked}))} />
          </div>
        </div>
        <DialogFooter>
          <DialogClose asChild>
