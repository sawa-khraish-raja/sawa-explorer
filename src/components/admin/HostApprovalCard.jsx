      ...
      >
        ...
        <CardContent className='space-y-3'>
          ...
          {request.status === 'pending' || request.status === 'under_review' ? (
            ...
            <Button onClick={() => setShowDetailsDialog(true)} variant='outline' className='w-full'>
              <Eye className='w-4 h-4 mr-2' />
              View Details
            </Button>
          )}
      ...
      <Dialog open={showApproveDialog} onOpenChange={setShowApproveDialog}>
        <DialogContent className='max-w-md'>
          <DialogHeader>
            ...
            <DialogDescription>Configure host settings before approval</DialogDescription>
          </DialogHeader>
          ...
          <div className='space-y-4 py-4'>
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setRejectionData({ ...rejectionData, rejection_reason: value })
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  setRejectionData({ ...rejectionData, rejection_details: e.target.value })
                }
