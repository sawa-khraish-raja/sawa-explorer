                ...
                <div className="flex-1">
                    ...
                    <div className="flex items-center gap-1">
                      {[1,2,3,4,5].map(star => (
                        <Star
                          key={star}
                          size={16}
                          className={star <= review.overall_rating ? 'fill-yellow-400 text-yellow-400' : 'text-gray-300'}
                        />
                      ))}
                    </div>
                  </div>
                  ...
                  {review.host_response && (
                    <div className="mt-4 pl-4 border-l-2 border-purple-200 bg-purple-50 p-3 rounded-r-lg">
                      <p className="text-sm font-semibold text-purple-900 mb-1">Response from host</p>
