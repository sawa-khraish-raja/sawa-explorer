              ...
              <div className="flex-1">
                ...
                {tripDuration > 0 && (
                  <Badge className="mt-2 bg-purple-100 text-purple-800">
                    ...
                    {tripDuration} {language === 'ar' ? (tripDuration === 1 ? 'يوم' : 'أيام') : (tripDuration === 1 ? 'day' : 'days')}
                  </Badge>
                )}
              </div>
            </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {adults > 0 && (
                    <Badge variant="outline" className="text-xs">
                      {adults} {language === 'ar' ? (adults === 1 ? 'بالغ' : 'بالغين') : (adults === 1 ? 'Adult' : 'Adults')}
                    </Badge>
                  )}
                  {children > 0 && (
                    <Badge variant="outline" className="text-xs">
                      {children} {language === 'ar' ? (children === 1 ? 'طفل' : 'أطفال') : (children === 1 ? 'Child' : 'Children')}
                    </Badge>
                  )}
                </div>
              </div>
