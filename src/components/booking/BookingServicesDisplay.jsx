...
export default function BookingServicesDisplay({ serviceIds = [], language = 'en', showDuration = false, serviceDurations = {} }) {
          ...
          >
            ...
            {showDuration && duration && (
              <span className="ml-1 text-purple-600 font-semibold flex-shrink-0">
                ({duration} {language === 'ar' ? (duration === 1 ? 'يوم' : 'أيام') : (duration === 1 ? 'day' : 'days')})
              </span>
            )}
          </Badge>
        );
