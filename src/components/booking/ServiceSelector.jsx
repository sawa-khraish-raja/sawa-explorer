...
import { SAWA_SERVICES, getConflictingServices, isFlexibleDurationService } from '../config/sawaServices';
            ...
            .map((serviceId) => {
              ...
              return (
                <div key={serviceId} className="space-y-2">
                  <Label htmlFor={`duration-${serviceId}`} className="text-sm font-medium text-gray-700">
                  ...
                  <p className="text-xs text-gray-500">
                    Your host will design a {serviceDurations[serviceId] || 7}-day personalized itinerary
                  </p>
                </div>
              );
            })}
