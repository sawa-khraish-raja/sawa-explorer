          ...
          <div className="bg-white p-4 rounded-lg border border-yellow-200">
            ...
            <ol className="space-y-1 text-yellow-800 text-xs">
              <li className="flex items-center gap-2">
                ...
                <span><strong>Hero + Search Bar</strong> - أول انطباع</span>
              </li>
              <li className="flex items-center gap-2">
                <Badge className="bg-purple-600">2</Badge>
                <span><strong>Destinations</strong> - يشوف الأماكن المتاحة</span>
              </li>
              <li className="flex items-center gap-2">
                <Badge className="bg-purple-600">3</Badge>
                <span><strong>Services</strong> - يفهم الخدمات</span>
              </li>
              <li className="flex items-center gap-2">
                <Badge className="bg-purple-600">4</Badge>
                <span><strong>Adventures</strong> - يشوف التجارب</span>
              </li>
              <li className="flex items-center gap-2">
                <Badge className="bg-green-600">5</Badge>
                <span><strong>✨ AI Trip Planner ✨</strong> - الآن جاهز لتجربة التخطيط!</span>
              </li>
              <li className="flex items-center gap-2">
                <Badge className="bg-purple-600">6</Badge>
                <span><strong>Why SAWA</strong> - يعزز الثقة</span>
              </li>
            </ol>
          </div>
        </CardContent>
          ...
          <div className="grid md:grid-cols-3 gap-3">
            <div className="bg-white p-3 rounded-lg border border-blue-200">
              ...
              <p className="text-xs text-blue-800">
                إنشاء component جديد أكبر وأجمل
              </p>
            </div>
            ...
            <div className="bg-white p-3 rounded-lg border border-blue-200">
              ...
              <p className="text-xs text-blue-800">
                نقل الـ section بعد Adventures
              </p>
            </div>
            ...
            <div className="bg-white p-3 rounded-lg border border-blue-200">
              ...
              <p className="text-xs text-blue-800">
                قياس التحسين في الـ conversion
              </p>
            </div>
          </div>
        </CardContent>
