...
export default function NavbarAudit() {
  ...
  const overallScore = Math.round(
    Object.values(audit).reduce((sum, section) => sum + section.score, 0) / Object.keys(audit).length
  );
              ...
              {section.issues && section.issues.length > 0 && (
                <div className="space-y-3">
                  ...
                  {section.issues.map((issue, idx) => (
                    <div key={idx} className={cn("border rounded-lg p-4", getSeverityColor(issue.severity))}>
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="space-y-1 text-sm">
                            <p><strong>Current:</strong> {issue.current}</p>
                            <p><strong>Recommended:</strong> {issue.recommended}</p>
