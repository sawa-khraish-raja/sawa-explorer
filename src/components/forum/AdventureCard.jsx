...
export default function AdventureCard({ post }) {
  ...
  const handleBookNow = (e) => {
    e.stopPropagation();
    navigate(createPageUrl(`CreateAdventureBooking?adventure_id=${post.adventure_entity_id}&guests=1`));
  };
    ...
    >
      <Card className="overflow-hidden group cursor-pointer hover:shadow-2xl transition-all duration-300 border-2 border-[#E6E6FF] hover:border-[#9933CC]">
        ...
        <div className="relative h-56 overflow-hidden">
          <img
            src={adventure.image_url || 'https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=800'}
            alt={adventure.title}
