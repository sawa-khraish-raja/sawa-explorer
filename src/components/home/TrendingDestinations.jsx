...
const ALL_DESTINATIONS = [
  ...
  },
  {
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/9/92/Istanbul_Bosphorus_IMG_8548_1960.jpg",
...
export default function TrendingDestinations() {
  ...
  const trendingDestinations = useMemo(() => {
    if (!bookings || bookings.length === 0) {
      ...
      return ALL_DESTINATIONS.filter(d => topTwoFallback.includes(d.city))
        .sort((a, b) => FALLBACK_RANKING.indexOf(a.city) - FALLBACK_RANKING.indexOf(b.city));
    }
    ...
    if (sortedCities.length <= 2) {
      ...
      return ALL_DESTINATIONS.filter(d => cityNames.includes(d.city))
    ...
    return ALL_DESTINATIONS.filter(d => topCities.includes(d.city))
      .sort((a,b) => topCities.indexOf(a.city) - topCities.indexOf(b.city));
