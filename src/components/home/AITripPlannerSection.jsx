              ...
              <div className='bg-gradient-to-br from-purple-50 to-white p-4 rounded-xl border-2 border-purple-200 w-full max-w-[280px] shadow-lg'>
                ...
                <div className='space-y-2'>
                  {[
                    {
                      icon: '🕌',
                      name: language === 'ar' ? 'الجامع الأموي' : 'Umayyad Mosque',
                      time: '09:00',
                    },
                    {
                      icon: '🍽️',
                      name: language === 'ar' ? 'غداء محلي' : 'Local Lunch',
                      time: '12:30',
                    },
                  ].map((item, i) => (
                    <div
                      key={i}
                      className='flex items-center gap-2 text-xs bg-white p-2 rounded-lg border border-purple-100'
                    >
