  ...
  const { data: adventures = [], isLoading, error } = useQuery({
    ...
    queryFn: async () => {
      ...
      const filteredAdventures = (allAdventures || [])
        .filter(a => {
          const isApproved = a.status === 'approved' || a.approval_status === 'approved';
          const hasSpace = a.current_participants < a.max_participants;
          const isFuture = new Date(a.date) > new Date();
          
          return isApproved && hasSpace && isFuture;
        })
        .slice(0, 6);
      
      return filteredAdventures;
    },
    staleTime: 5 * 60 * 1000, // ✅ 5 minutes - مغامرات الصفحة الرئيسية
              ...
              <CardContent className="p-4">
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex items-center gap-2 text-sm text-gray-600">
                    ...
                    <span className="truncate">{adventure.city}</span>
                  </div>
                  ...
                  <div className="flex items-center gap-2 text-sm text-gray-600">
                    ...
                    <span>
                      {adventure.current_participants || 0}/{adventure.max_participants} spots
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-2xl font-bold text-green-600">
                      {adventure.traveler_total_price?.toFixed(0) || adventure.host_price?.toFixed(0) || 0}
                    </span>
