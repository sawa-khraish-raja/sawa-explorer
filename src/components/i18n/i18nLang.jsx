...
const SUPPORTED_LANGS = (typeof window !== 'undefined' && window.ENV?.SAWA_LANGS) 
  || "ar,en,de,fr,es,nl,it,sv,da,tr";
...
export function normLang(code) {
  if (!code || code === 'auto' || code === 'auto-detected') {
    ...
    const stored = typeof localStorage !== 'undefined' ? localStorage.getItem('sawa_display_lang') : null;
