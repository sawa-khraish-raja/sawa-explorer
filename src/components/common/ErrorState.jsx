...
export default function ErrorState({ 
  ...
  return (
    ...
    >
      ...
      <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 break-words px-4">
        {title}
      </h3>
      
      <p className="text-sm sm:text-base text-gray-600 mb-6 max-w-md break-words px-4">
        {message}
      </p>
