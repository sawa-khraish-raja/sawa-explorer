...
const presets = [
    { label: "Next 7 days", getRange: () => ({ from: new Date(), to: addDays(new Date(), 6) }) },
    { label: "Next 14 days", getRange: () => ({ from: new Date(), to: addDays(new Date(), 13) }) },
          ...
          <div className="flex items-center justify-center border rounded-lg h-14 md:h-12">
             ...
             >
                ...
                <div className="font-semibold text-sm">
                  {currentDisplayDate?.from ? format(currentDisplayDate.from, "LLL dd, y") : <span className="font-normal text-muted-foreground">&nbsp;</span>}
                </div>
             </button>
             ...
             >
                ...
                <div className="font-semibold text-sm">
                  {currentDisplayDate?.to ? format(currentDisplayDate.to, "LLL dd, y") : <span className="font-normal text-muted-foreground">&nbsp;</span>}
                </div>
             </button>
          </div>
        </PopoverTrigger>
              ...
              <div className="p-4 border-b md:border-b-0 md:border-r flex flex-col gap-4 bg-gray-50 md:bg-white">
                ...
                {showFlexDateToggle && onFlexDateChange && (
                     <div className="flex items-center space-x-2 pt-4 border-t">
                        <Switch id="flex-date-toggle" checked={isFlexDate} onCheckedChange={onFlexDateChange} />
                        <Label htmlFor="flex-date-toggle" className="text-sm">Flexible dates (±3 days)</Label>
                    </div>
                )}
              </div>
